...
function buildTxs() {
  ...
  txs[2].addInput(fakeTxId(10), 0)

  txs[3].addInput(fakeTxId(2), 1)
  txs[3].addInput(fakeTxId(5), 1)
  txs[3].addInput(fakeTxId(7), 0)

  txs[4].addInput(fakeTxId(7), 1)
  ...
  txs[8].addInput(fakeTxId(10), 1)

  txs[9].addInput(fakeTxId(10), 2)
